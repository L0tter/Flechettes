...
public class PanneauTextuel implements Panneau{
	...
	public Flechette viserEtLancerFlechette() {
		...
		System.out.println("Quelle Zone visez-vous ? Entrez un nombre entre 0 et 50.");
		int zone=UtilitairesJeux.lireEntierComprisEntre(0, 50, "Inférieur à 0 ou supérieur à 50 ?!");
